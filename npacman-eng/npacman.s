...
; pauseTime--;
;
L0074:	dec     _pauseTime
;
; if (STATE_GAME == gameState) {     
;
L0075:	lda     _STATE_GAME
	cmp     _gameState
	jne     L0086
;
; if (((pad1 & PAD_START) || (pad2 & PAD_START)) && playersTime == 0) {
...
; if (pacmanLastUpdateTime > 0 ) {
;
L0041:	lda     _pacmanLastUpdateTime
	beq     L0082
;
...
; if (pacGirlLastUpdateTime > 0) {
;
L0083:	lda     _pacGirlLastUpdateTime
	beq     L0084
;
...
; refreshGame();     
;
L000B:	jsr     _refreshGame
;
; if (STATE_PAUSE == gameState) {
;
L000C:	lda     _STATE_PAUSE
	cmp     _gameState
	bne     L0008
;
